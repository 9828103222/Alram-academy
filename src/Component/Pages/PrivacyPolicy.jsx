    ...
    <>
      <div className="AAboutSection">
        ...
        <div className="AAboutmove">
          <h1>Privacy policy</h1>
          <p>
            Home<i class="fa-solid fa-angle-right"></i>Privacy policy
          </p>
        </div>
      </div>
        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-8 col-md-8 col-sm-12">
                    <h1>Who we are</h1>
                    <p>Suggested text: Our website address is: https://alramacademy.com.</p>
                    ...
                    <h1>Media</h1>
                    <p>Suggested text: If you upload images to the website, you should avoid uploading images with embedded location data (EXIF GPS) included. Visitors to the website can download and extract any location data from images on the website.
...
<h1>Who we share your data with
</h1>
<p>Suggested text: If you request a password reset, your IP address will be included in the reset email.
</p>


<h1>How long we retain your data</h1>
<p>Suggested text: If you leave a comment, the comment and its metadata are retained indefinitely. This is so we can recognize and approve any follow-up comments automatically instead of holding them in a moderation queue.</p><p>
...
<p>Suggested text: Visitor comments may be checked through an automated spam detection service.</p>
                ...
                <div className="col-lg-4 col-md-4 col-sm-12">
                    <h1>Categories</h1>
                    <p>Blog</p>
                    <p style={{ fontWeight: "bold" }}>Recent Posts</p>
                    <p style={{ fontWeight: "bold", textDecoration: "underline" }}>Ecommerce Marketing Mastery<br/> Course – Become a Certified<br/> Ecommerce Expert</p>
                    <p style={{color:"gray"}}>November 9, 2025 <span style={{textDecoration: "underline"}}>No Comments</span></p>
                </div>
            </div>
        </div>
      </div>
